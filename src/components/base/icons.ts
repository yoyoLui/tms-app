/* ============================================================
 * 图标 SVG path 数据（24x24 视图，与 lucide-icons 兼容）
 * 通过 TmsIcon 组件以 data:image/svg+xml 形式渲染，兼容
 * 微信小程序与 H5。
 * ============================================================ */
...
export const iconPathMap: Record<string, string> = {
  ...
  'wallet':
    '<path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2"/><path d="M21 12h-6a2 2 0 0 0 0 4h6"/>',
  'user':
...
/**
 * 构建 data:image/svg+xml URI（兼容微信小程序与 H5）
 */
export function buildSvgDataUri(
  ...
  const svg =
    ...
    `fill="${fill}" stroke="${color}" stroke-width="${stroke}" ` +
